...
for (const name of ["Schema", "Datasets", "Entities", "Joins", "Store", "Metrics", "Charts", "Insight", "Text", "Report", "AI", "Tools"]) {
  if (!mod.exports[name]) { console.error("FAIL: module " + name + " missing on SalesCore"); process.exit(1); }
}
console.log("SalesCore modules:", ["Schema","Datasets","Entities","Joins","Store","Metrics","Charts","Insight","Text","Report","AI","Tools"].join(", "));
